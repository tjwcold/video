...
def run() -> Iterator[List[BenchmarkCycleSet]]:
	...
	state_manager.init_item('landmark_detector_score', 0)
	...
	benchmarks = []
	target_paths = [ videokit.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in videokit.choices.benchmark_set ]
