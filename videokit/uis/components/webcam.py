...
from videokit.camera_manager import clear_camera_pool, get_local_camera_capture
from videokit.filesystem import has_image
from videokit.streamer import multi_process_capture, open_stream
from videokit.types import Fps, VisionFrame, WebcamMode
from videokit.uis.core import get_ui_component
from videokit.uis.types import File
from videokit.vision import fit_cover_frame, unpack_resolution
...
def start(webcam_device_id : int, webcam_mode : WebcamMode, webcam_resolution : str, webcam_fps : Fps) -> Iterator[VisionFrame]:
	state_manager.init_item('region_selector_mode', 'one')
