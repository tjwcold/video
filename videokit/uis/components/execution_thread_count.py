...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(videokit.choices.execution_thread_count_range),
		minimum = videokit.choices.execution_thread_count_range[0],
		maximum = videokit.choices.execution_thread_count_range[-1]
	)
