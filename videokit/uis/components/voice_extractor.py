...
from videokit import state_manager, translator, voice_extractor
from videokit.filesystem import is_video
from videokit.types import VoiceExtractorModel
...
def render() -> None:
	...
	VOICE_EXTRACTOR_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = videokit.choices.voice_extractor_models,
