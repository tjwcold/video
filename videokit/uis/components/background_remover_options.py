...
from videokit.processors.modules.background_remover import choices as background_remover_choices
from videokit.processors.modules.background_remover.types import BackgroundRemoverModel
	...
	with gradio.Group(visible = has_background_remover) as BACKGROUND_REMOVER_FILL_COLOR_WRAPPER:
		with gradio.Row():
			BACKGROUND_REMOVER_FILL_COLOR_RED_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_red_number', 'videokit.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_FILL_COLOR_GREEN_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_green_number', 'videokit.processors.modules.background_remover'),
		...
		with gradio.Row():
			BACKGROUND_REMOVER_FILL_COLOR_BLUE_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_blue_number', 'videokit.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_FILL_COLOR_ALPHA_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_alpha_number', 'videokit.processors.modules.background_remover'),
	...
	with gradio.Group(visible = has_background_remover) as BACKGROUND_REMOVER_DESPILL_COLOR_WRAPPER:
		with gradio.Row():
			BACKGROUND_REMOVER_DESPILL_COLOR_RED_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_red_number', 'videokit.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_DESPILL_COLOR_GREEN_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_green_number', 'videokit.processors.modules.background_remover'),
		...
		with gradio.Row():
			BACKGROUND_REMOVER_DESPILL_COLOR_BLUE_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_blue_number', 'videokit.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_DESPILL_COLOR_ALPHA_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_alpha_number', 'videokit.processors.modules.background_remover'),
