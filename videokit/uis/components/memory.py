...
from videokit.types import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = videokit.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(videokit.choices.system_memory_limit_range),
		minimum = videokit.choices.system_memory_limit_range[0],
		maximum = videokit.choices.system_memory_limit_range[-1],
