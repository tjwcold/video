...
from videokit.processors.modules.style_transfer.types import StyleTransferModel, StyleTransferSet, StyleTransferWeight


style_transfer_set : StyleTransferSet =\
{
...
style_transfer_models : List[StyleTransferModel] = list(get_args(StyleTransferModel))

style_transfer_weight_range : Sequence[StyleTransferWeight] = create_float_range(0.0, 1.0, 0.05)
