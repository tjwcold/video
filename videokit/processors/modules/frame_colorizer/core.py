...
from videokit import config, content_analyser, inference_manager, logger, state_manager, translator, video_manager
...
from videokit.processors.modules.frame_colorizer import choices as frame_colorizer_choices
from videokit.processors.modules.frame_colorizer.types import FrameColorizerInputs
...
from videokit.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from videokit.vision import blend_frame, read_static_image, read_static_video_frame, unpack_resolution
...
def get_inference_pool() -> InferencePool:
	frame_colorizer_model = state_manager.get_item('frame_colorizer_model') or 'ddcolor'
	model_names = [ frame_colorizer_model ]
...
def get_model_options() -> ModelOptions:
	model_name = state_manager.get_item('frame_colorizer_model') or 'ddcolor'
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		videokit.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
