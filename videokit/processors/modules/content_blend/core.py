...
from videokit.download import conditional_download_hashes, conditional_download_sources, resolve_download_url_by_provider
...
from videokit.types import ApplyStateItem, Args, DownloadScope, Region, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
from videokit.vision import conditional_match_frame_color, read_static_image, read_static_video_frame
...
def swap_region(target_region : Region, temp_vision_frame : VisionFrame) -> VisionFrame:
...
def process_frame(inputs : ContentBlendInputs) -> ProcessorOutputs:
	...
	if target_regions:
		for target_region in target_regions:
			...
			temp_vision_frame = swap_region(target_region, temp_vision_frame)
