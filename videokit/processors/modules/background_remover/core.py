...
from videokit.common_helper import is_macos, is_windows
...
from videokit.normalizer import normalize_color
from videokit.processors.modules.background_remover import choices as background_remover_choices
from videokit.processors.modules.background_remover.types import BackgroundRemoverInputs
...
from videokit.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		videokit.jobs.job_store.register_step_keys([ 'background_remover_model', 'background_remover_fill_color', 'background_remover_despill_color' ])
