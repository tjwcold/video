...
from videokit import curl_builder, logger, process_manager, state_manager, translator
from videokit.filesystem import get_file_name, get_file_size, is_file, remove_file
from videokit.hash_helper import validate_hash
from videokit.types import Command, DownloadProvider, DownloadSet
...
def resolve_download_url_by_provider(download_provider : DownloadProvider, base_name : str, file_name : str) -> Optional[str]:
	download_provider_value = videokit.choices.download_provider_set.get(download_provider)
